...
TOOLS = [
    {
        ...
        "description": (
            ...
            "conclusion. `unclassified` means the note declared no class, which is MOST of the "
            "corpus and is ABSENT SIGNAL about the label rather than a claim about the note — "
            "treat it exactly as you treat `unjudged` confidence, and never as a downgrade.\n\n"
